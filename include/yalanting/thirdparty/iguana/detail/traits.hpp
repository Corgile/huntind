...
#include "thirdparty/iguana/define.h"

namespace iguana {

template<class T>
struct is_signed_integral_like
    : std::integral_constant<bool, (std::is_integral<T>::value) &&
                                   std::is_signed<T>::value> {
};

template<class T>
struct is_unsigned_integral_like
    : std::integral_constant<bool, (std::is_integral<T>::value) &&
...
template<typename T>
struct is_std_string : is_template_instant_of<std::basic_string, T> {
};
